<div class="form-group vcff-meta-textfield <?php echo $extra_class; ?>">
    ...
    <div class="col-sm-9">
        ...
        <input name="<?php echo $machine_code; ?>" type="password" value="<?php echo $this->value; ?>" class="form-control vcff-meta-field <?php echo $extra_class; ?>" <?php if ($required): ?>required<?php endif; ?>>
