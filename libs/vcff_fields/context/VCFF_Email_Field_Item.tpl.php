<div data-vcff-field-name="<?php echo $machine_code; ?>" class="vcff-field vcff-text-field <?php echo $extra_class; ?> <?php echo $css_class; ?>" <?php if ($this->Is_Hidden()): ?>style="display:none;"<?php endif; ?>>
    ...
    <input name="<?php echo $machine_code; ?>" <?php echo $attributes; ?> <?php if ($placeholder): ?> placeholder="<?php echo $placeholder; ?><?php if ($this->Is_Required()): ?> *<?php endif; ?>"<?php endif; ?> type="email" value="<?php echo $this->posted_value ? $this->posted_value : $default_value; ?>"<?php if ($is_disabled == 'yes'): ?> disabled="disabled"<?php endif; ?> class="form-control <?php if ($this->Has_Dependents()): ?>key-change check-change<?php endif; ?> <?php echo $field_extra_class; ?>">
