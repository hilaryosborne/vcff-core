...
class VCFF_Radio_List {
    
    static $field_type = 'vcff_list_radio';
    
    static $field_title = 'Radio List';
    
    static $item_class = 'VCFF_Radio_List_Item';
...
vcff_map_field('VCFF_Radio_List');