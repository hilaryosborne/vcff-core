...
class VCFF_Textarea_Field {
    
    static $field_type = 'vcff_textarea_field';
    
    static $field_title = 'Textarea Field';

    static $item_class = 'VCFF_Textarea_Field_Item';
...
vcff_map_field('VCFF_Textarea_Field');