...
vcff_map_field(array(
    'type' => 'vcff_field_text',
    'title' => 'Single Text Input',
    'class' => 'VCFF_Text_Input_Item',
    'filter_logic' => array(
        array(
    ...
    'conditional_logic' => array(
        ...
        array(
            ...
            'title' => 'Contains',
            'callback' => 'CONTAINS',
            'description' => 'Checks if the field value contains a string',
            'value' => true
        ),
        array(
            'machine_code' => 'STARTS_WITH',
            'title' => 'Starts with',
            'callback' => 'STARTS_WITH',
            'description' => 'Checks if the field value starts with a string',
            'value' => true
        ),
        array(
            'machine_code' => 'ENDS_WITH',
            'title' => 'Ends with',
            'callback' => 'ENDS_WITH',
            'description' => 'Checks if the field value ends with a string',
            'value' => true
        ),
    ),
