...
class VCFF_Single_Select_Field {

    static $field_type = 'vcff_field_single_select';

    static $field_title = 'Single Select Field';

    static $item_class = 'VCFF_Single_Select_Field_Item';
...
vcff_map_field('VCFF_Single_Select_Field');