...
class VCFF_Password_Field {

    static $field_type = 'vcff_field_password';

    static $field_title = 'Password';

    static $item_class = 'VCFF_Password_Field_Item';
...
vcff_map_field('VCFF_Password_Field');