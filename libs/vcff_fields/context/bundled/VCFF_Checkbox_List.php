...
class VCFF_Checkbox_List {
    
    static $field_type = 'vcff_list_checkbox';
    
    static $field_title = 'Checkbox List';
    
    static $item_class = 'VCFF_Checkbox_List_Item';
...
vcff_map_field('VCFF_Checkbox_List');