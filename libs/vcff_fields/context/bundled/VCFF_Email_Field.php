...
class VCFF_Email_Field {
    
    static $field_type = 'vcff_field_email';
    
    static $field_title = 'Email Field';

    static $item_class = 'VCFF_Email_Field_Item';
...
vcff_map_field('VCFF_Email_Field');