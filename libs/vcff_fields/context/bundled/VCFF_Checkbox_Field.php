...
class VCFF_Checkbox_Field {
    
    static $field_type = 'vcff_field_checkbox';
    
    static $field_title = 'Checkbox Field';

    static $item_class = 'VCFF_Checkbox_Field_Item';
...
vcff_map_field('VCFF_Checkbox_Field');