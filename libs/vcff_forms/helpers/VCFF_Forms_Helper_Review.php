...
class VCFF_Forms_Helper_Review extends VCFF_Helper {
    ...
    public function Review($params = array()) {
        ...
        $form_instance->Do_Action('form_before_review',array('helper' => $this));
        // Retrieve the validation result
        do_action('vcff_form_before_review', $form_instance);
        // Create the Instance
        $this->_Review_Events();
        // Do any form actions on create
        $form_instance->Do_Action('form_review',array('helper' => $this));
        // Do any form actions on create
        $form_instance->Do_Action('form_after_review',array('helper' => $this));
        // Retrieve the validation result
    ...
    protected function _Review_Events() {
        ...
        $events_trigger_helper
            ...
            ->Trigger();
        // Do any form actions on create
        $form_instance->Do_Action('form_review_events',array('helper' => $this));
        // Retrieve the validation result
