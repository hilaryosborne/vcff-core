    ...
    <table width="100%" class="table table-striped">
        <thead>
            <tr>
                ...
                <?php do_action('vcff_event_list_thead',$this); ?>
        ...
        <tbody>
            ...
            <tr data-action-id="<?php echo $action_instance->id; ?>" class="event-row <?php if ($i % 2 == 0): ?>even<?php else: ?>odd<?php endif; ?>">
                ...
                <td class="col-order"><a href="" class="move-link dashicon dashicons-arrow-up move-up"></a><a href="" class="move-link dashicon dashicons-arrow-down move-down"></a></td>
                <?php do_action('vcff_event_list_tbody',$this); ?>
                <td class="col-name">
                ...
                <td class="col-delete text-right"><a href="" class="delete-action">Remove Event</a></td>
            </tr>
            <?php $i++; ?>
            <?php endforeach; ?>
        </tbody>
