...
class Curly_Container_Text extends VCFF_Item {
    
    public $form_instance;
    
    public $tag = 'container_text';
    
    public $name = '(TEXT Field Value)';
    
    public $category = 'Containers as TEXT';
    
    public $hint = 'container_text:machine_name';
...
vcff_map_context('Curly_Container_Text');
